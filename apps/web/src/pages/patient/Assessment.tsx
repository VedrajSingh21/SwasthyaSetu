          ...
          <AnimatePresence mode="wait">
            {isSubmitting ? (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-slate-800">Preparing your care requirement...</h3>
                <p className="text-slate-500 text-sm mt-2 text-center max-w-xs">
                  Our system is analyzing your assessment to determine the best care bundle for you.
                </p>
              </motion.div>
            ) : (
              <motion.div
